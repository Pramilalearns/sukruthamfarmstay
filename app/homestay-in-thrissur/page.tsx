                        ...
                        <ScrollAnimation className="relative bg-white p-8 md:p-12 rounded-[2rem] shadow-sm border border-stone-100 flex flex-col justify-center">
                            ...
                            <div className="mb-10 pt-4 md:pt-0 pr-0 sm:pr-20">
                                ...
                                <p className="text-stone-600 text-base leading-relaxed">
                                    Sukrutham Farm Stay in Thrissur offers spacious rooms that blend traditional farmhouse aesthetics with modern comfort. Natural materials like stone, wood, and clay echo the surrounding landscape, creating spaces that feel calm and grounded. Large windows and private terraces frame breathtaking views of the hills, streams, and cascading waterfalls around the property.
                                </p>
                            </div>
