export const testimonials = [
    {
        name: "Dr Shruthi Devi & Family / Dr Rama Devi & Family",
        location: "Bangalore / Udumalpet",
        text: "We thoroughly enjoyed our stay in Sukrutham. We felt so much at home and our big family of 11 people including the kids did not want to leave and hence we extended our stay for another day. Mr K P Murali has set a standard for Homestays and has actually impressed us with his beautifully designed and decorated home. The food was home cooked, healthy and delicious. Sukrutham has impressed us in many ways — we will definitely be back. IMPRESSED BEYOND WORDS… 11/10 stars.",
        rating: 5
    },
    {
        name: "Karthik Iyer",
        location: "Coimbatore",
        text: "Awesome place in the lap of nature and culture. Great location, food and very hospitable. If you truly want to experience a place, stay by yourself and breathe — Sukrutham is the place. Mr. Murali is an amazing host. Thoroughly enjoyed my stay and will definitely come back.",
        rating: 5
    },
    {
        name: "Anastasia Chebaksarova",
    ...
    {
        name: "R. Mahesh Iyer & Family",
        location: "NC, USA",
        text: "We enjoyed a most unique, relaxing & enjoyable experience at Sukrutham. This is not your typical commercial resort. Nestled in a quaint village adjacent to lush paddy fields, and with abundant bird life we were enverloped in silence & peace. The host (Murali) is very hospitable & thoughtful. The food is custom made with local ingredients & is delicious. The town of Thrissur was easily accessible & we saw ancient temples, enjoyed ayurvedic massages nearby and took strolls in the local roads. The house itself is a typical kerala style construction & a special mention for chippy the dog!! loved it!!!",
        rating: 5
    },
    {
        name: "Karin Przygocki",
        location: "USA",
    ...
    {
        name: "Ankit Mehta & Rohan Gholkar",
        location: "Rajasthan / Canada",
    ...
    {
        name: "Balaji & Kalpana Balaji",
        location: "",
        text: "Heard rave reviews about the place from my husband after his first visit to Sukrutham. Was excited to see the place and fell in love with Sukrutham the moment i stepped in. The place is tastefully done and well maintained. A tour around the garden is really so calming for the mind. Nevertheless Kudos to Murali for the wonderful place he has and the hospitality. If you are looking for a place away from the mad rush, noice etc., Sukrutham is The Place nested among paddy fields on one side, Reserve forest and stream around. Eagerly look forward to my next visit here with my sons.",
        rating: 5
    },
    {
        name: "RK Menon",
    ...
    {
        name: "Abhishek George",
        location: "Hyderabad",
        text: "Quiet and Serene, Sukrutyam Farmstay evokes a sense of tranquility that's very rarely found within the city. Definitely recommend if you're looking for a break and to reconnect with nature.",
        rating: 5
    },
    {
        name: "Ram Lakshminarayanan",
        location: "Singapore",
    ...
    },
    {
        ...
        location: "Executive Director, Federal Bank",
    ...
    {
        name: "Lina & Shibin Kumar",
        location: "Technology Director, Wells Fargo | Bangalore",
    ...
    },
    {
        name: "Umesh Mani",
        location: "Chennai",
        text: "We have just had a fantastic stay at Sukrutham. A short family outing that was intended as a break from the forever rushed city routine, this has been the perfect break. Beautifully created surroundings, lovely décor & artefacts, warm and hospitable people, great food, and to top it all Murali with his cheer-full attitude ever willing to do whatever it takes to make us comfortable & happy- has resulted in a fabulous, memorable experience. And everyone is so appreciative of you and the way you took care of us. You've earned lots of blessings and goodwill Thank You Murali and all the very best to you!",
        rating: 5
    },
    {
        name: "Saurav",
        location: "Bangalore",
        text: "We had an amazing time here. Our dog really enjoyed the space and wonderful company (Thanks, Chippy!) The food was fresh and yummy! The property is beautiful and such a good escape from city life. Cannot recommend enough Thanks for everything!",
        rating: 5
    },
    {
        name: "C.S. Hariharan",
        location: "Chennai",
        text: "One of the best vacations of the year! What sets Sukrutham apart is the attention to details. Mr. Murali has taken efforts to ensure that guests feel and enjoy the real taste of villages in Kerala. Simply beautiful! Lots of memories to carry home. Thanks a ton.",
        rating: 5
    }
];
